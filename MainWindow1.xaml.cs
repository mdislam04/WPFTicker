    ...
    public partial class MainWindow : Window
    {
        ...
        void setPrices()
        {
            if (koinexPrice != null && binancePrice != null)
            {
                ...
                lblEth.Content = fetchBinancePricebyPara("BTC");
                lblBinance.Content = fetchBinancePricebyPara("ETH");
            }
        }
        ...
        private void btnZoomIn_Click(object sender, RoutedEventArgs e)
        {
            ...
            lblBinance.FontSize = lblBinance.FontSize + 4;
            lblSep.FontSize = lblSep.FontSize + 4;
            lblSep1.FontSize = lblSep1.FontSize + 4;
            lblEth.FontSize = lblEth.FontSize + 4;
        }
